...
Ex. 3.2 Given data on two variables X and Y, consider fitting a cubic polynomial regression model f X =∑3 βjXj 
j=0

In addition to plotting the fitted curve, you would like a 95% confidence band about the curve. Consider the following two approaches:

1. At each point x0, form a 95% confidence interval for the linear
function αT β = ∑ 3 β j x0 j . j=0

2. Form a 95% confidence set for β, which in turn generates confidence intervals for f x0 .
