...
Azure <- FALSE # set as global variable
```
...
```{r comment=NA}
# from "visualize.R" - edited to match text

cor.BikeShare <- cor(BikeShare[ , c("mnth", "hr", "weathersit", "temp",
                                    "hum", "windspeed", "isWorking", 
                                    "monthCount", "count")])

diag(cor.BikeShare) <- 0.0 

plot(levelplot(cor.BikeShare, 
               main = "Correlation matrix for all bike users",
               scales = list(x = list(rot = 90), cex = 1.0)))
```
